...
extern "C" {
#endif
void *dbg_calloc(size_t nmemb, size_t size, const char *, int);
void *dbg_malloc(size_t size, const char *, int);
void *dbg_realloc(void *ptr, size_t size, const char *, int);
char *dbg_strdup(const char *s, const char *, int);
void dbg_free(void *ptr, const char *, int);

void assureNoLeaks(const char *file);
...
#ifdef __cplusplus
void *operator new(size_t size, const char *, int, bool);
void *operator new[](size_t size, const char *, int, bool);
void operator delete(void *ptr);
void operator delete[](void *ptr);
void removeEntry(void *ptr, const char *, int, int);
#endif
...
#define DELETE(ptr) do { removeEntry((ptr), __FILE__, __LINE__, 0); delete(ptr); } while (0)
#define DELETE_ARR(ptr) do { removeEntry((ptr), __FILE__, __LINE__, 1); delete[](ptr); } while (0)
//#define DELETE_OBJARR(ptr) do { removeEntry((ptr), __FILE__, __LINE__, 2); delete[](ptr); } while (0)
#endif
