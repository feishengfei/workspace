...
public class List7Activity extends ListActivity
{
	private static final String TAG = "List 7:";
			...
			String number)
	{
		...
		if (dataCursor.getCount() > 0) {
			if (dataCursor.moveToFirst()) {
				...
				Log.e(TAG, "1]can't locate the id" + id);
			}
		}
		else {
			Log.e(TAG, "2]can't locate the id" + id);
			return;
		}
