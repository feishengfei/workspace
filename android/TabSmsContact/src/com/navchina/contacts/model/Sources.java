...
public class Sources extends BroadcastReceiver implements OnAccountsUpdateListener {
    ...
    private HashMap<String, ContactsSource> mSources = new HashMap();
    private HashSet<String> mKnownPackages = new HashSet();
    ...
    public ArrayList<Account> getAccounts(boolean writableOnly) {
        ...
        final ArrayList<Account> matching = new ArrayList();
