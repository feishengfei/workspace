...
public class SaveRestoreState extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        //TODO
        CharSequence saved_char = savedInstanceState.getCharSequence("saved");
      
        if (null != saved_char) {
            setSavedText(saved_char);
        }
        */
    }
    ...
    protected void onSaveInstanceState(Bundle outState)
    {
        ...
        //save
        Toast.makeText(this, "save" + getSavedText(), Toast.LENGTH_SHORT).show();
        outState.putCharSequence("saved", getSavedText());
