...
public class PersistentState extends Activity
{
    ...
    protected void onResume() {
        ...
        if (restoredText != null) {
            ...
            Toast.makeText(this, "select:" + selectionStart + "~" + selectionEnd, Toast.LENGTH_SHORT).show();
    ...
    protected void onPause() {
        ...
        Toast.makeText(this, "select:" + mSaved.getSelectionStart() + "~" + mSaved.getSelectionEnd(), Toast.LENGTH_SHORT).show();
