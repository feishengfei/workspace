...
public class ActionBarDisplayOptions extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar.addTab(bar.newTab().setText(R.string.tabs_1_tab_1).setTabListener(this));
        bar.addTab(bar.newTab().setText(R.string.tabs_1_tab_2).setTabListener(this));
        bar.addTab(bar.newTab().setText(R.string.tabs_1_tab_3).setTabListener(this));
    }
